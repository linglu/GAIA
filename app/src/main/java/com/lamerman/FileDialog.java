...
import com.csr.gaia.android.replacevoiceprompts.R;
...
public class FileDialog extends ListActivity {
	...
	/**
	 */
	private void highlightSelectedItem(ListView l, View v) {
		for(int a = 0; a < l.getChildCount(); a++)
        {
            l.getChildAt(a).setBackgroundColor(Color.BLACK);
        }
